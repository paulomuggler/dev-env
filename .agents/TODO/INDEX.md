...
- [x] [lazy-llm-session-management](done/lazy-llm-session-management.md) - Add session listing, management, and TUI session manager
- [x] [lazy-llm-tui-pane-manager](done/lazy-llm-tui-pane-manager.md) - Build TUI pane manager popup for multi-AI management
- [x] [lazy-llm-conditional-nvim-keymaps](done/lazy-llm-conditional-nvim-keymaps.md) - Make nvim keymaps conditional on tmux/lazy-llm context
- [x] [lazy-llm-scope-tmux-keybindings](done/lazy-llm-scope-tmux-keybindings.md) - Scope tmux keybindings to avoid conflicts
- [x] [lazy-llm-error-feedback](done/lazy-llm-error-feedback.md) - Surface errors from async commands to the user
