...
- [x] [lazy-llm-tui-pane-manager](lazy-llm-tui-pane-manager.md) - Build TUI pane manager popup for multi-AI management
...
- [x] [lazy-llm-error-feedback](lazy-llm-error-feedback.md) - Surface errors from async commands to the user
- [x] [lazy-llm-fix-append-keystroke-injection](lazy-llm-fix-append-keystroke-injection.md) - Replace llm-append keystroke injection with reliable method
- [x] [lazy-llm-pane-remove-confirmation](lazy-llm-pane-remove-confirmation.md) - Add confirmation before removing AI panes
